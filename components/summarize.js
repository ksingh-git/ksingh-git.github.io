...
const Summarize = ({content}) => {
    ...
    const [requestContent] = useState("Give me a summary in not more than 100 words : ");
    ...
    useEffect(() => {
        const handleClickOutside = (event) => {
            if (isModalOpen && modalRef.current && !modalRef.current.contains(event.target) && !event.target.closest(".modal")) {
                closeModal();
            }
        };
    ...
    return (<div className="flex justify-center">
        ...
        {isModalOpen && (<>
            <div
                className="fixed left-0 top-0 z-50 flex h-full w-full items-center justify-center bg-black bg-opacity-50 backdrop-blur">
                    ...
                    <div className="relative rounded-lg bg-white shadow dark:bg-gray-700">
                        <div className="space-y-4 p-4 md:p-5">
                            <div className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                                {isLoading ? (<TextSkeleton/>) : (// Render summary when isLoading is false
                            ...
                            {" "}
                            <div
                                className="flex items-center justify-center border-t border-gray-200 p-4 dark:border-gray-600 md:p-5">
                                <button
                                    onClick={closeModal}
                                    type="button"
