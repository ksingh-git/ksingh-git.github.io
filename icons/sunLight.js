        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 512 512">
            <defs>
                ...
                <symbol id="SVG0a04Kbxn" viewBox="0 0 384 384">
                    <circle cx="192" cy="192" r="84" fill="url(#SVGeq4GoeLw)" stroke="#f8af18" strokeMiterlimit="10"
                            strokeWidth="6"/>
                    <path fill="none" stroke="#fbbf24" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="24"
            ...
            <use width="384" height="384" href="#SVG0a04Kbxn" transform="translate(64 64)"/>
        </svg>
    );
}

export default LightModeSvgComponent;