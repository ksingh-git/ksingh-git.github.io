const PythonIcon = () => {
    return (<svg xmlns="http://www.w3.org/2000/svg" width={32} height={32} viewBox="0 0 128 128">
        <linearGradient id="SVGo658XMjL" x1={70.252} x2={170.659} y1={1237.476} y2={1151.089}
        ...
        <linearGradient id="SVGNPSltbKo" x1={209.474} x2={173.62} y1={1098.811} y2={1149.537}
                        gradientTransform="matrix(.563 0 0 -.568 -29.215 707.817)" gradientUnits="userSpaceOnUse">
            <stop offset={0} stopColor="#ffd43b"></stop>
            <stop offset={1} stopColor="#ffe873"></stop>
        </linearGradient>
        <path fill="url(#SVGo658XMjL)"
        ...
        <path fill="url(#SVGNPSltbKo)"
              ...
              transform="translate(0 10.26)"></path>
        <radialGradient id="SVGxM6OSbnB" cx={1825.678} cy={444.45} r={26.743}
